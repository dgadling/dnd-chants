...
export function MobileCard(props: Props) {
  return (
    <div className="card px-3 py-3 flex flex-col gap-3 rounded-xl">
      ...
      <input className="input text-[14px] h-11" value={props.box} onChange={(e) => props.onBoxChange(e.target.value)} placeholder="native [roman]" />
